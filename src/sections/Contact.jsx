...
export default function Contact() {
  ...
  return (
    <>
        <section id="contact" className="relative w-full h-full  px-4 md:px-10  flex flex-col justify-center items-center mt-10 overflow-hidden" >
            ...
            <div className="h-max z-10 grid grid-cols-12 my-16 ">
                <div className="grid grid-cols-10 col-span-12 md:col-start-2 md:col-span-10 bg-gray-50 shadow-xl">
                    <div className="flex rounded-t-xl xl:rounded-l-xl col-span-12 md:col-span-10 xl:col-start-1 xl:col-span-4 relative overflow-hidden">
                    ...
                    <div className="relative rounded-r-xl col-span-10 xl:col-span-6 font-poppins text-sm p-4 md:p-8 text-justify">
                        {t('contact_summary')}
                    </div>
                </div>
            </div>
