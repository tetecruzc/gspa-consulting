...
export default function Banner() {
  ...
  return (
    <>
        <section id="banner" className="font-poppins relative translate-y-[-75px] min-h-[90vh] py-5 bg-center bg-cover bg-no-repeat flex justify-center items-center" style={{ backgroundImage: "url(" + bannerBackground + ")" }}>
